...
2. How does a ReLU die?  
    ...
    My first question when I learned the problem of a dying ReLU is that, how does ReLU actually work with the left side with gradient = 0? If a data point put the current weights to the left side of ReLU, isn't that the ReLU just dies instantly and will never come back?
